...
for(const expired of ['GMGN','activity'])test(`${expired} expiring during mint preflight independently blocks broadcast`,async()=>{
  ...
  const security={isHoneypot:false,buyTax:0,sellTax:0,observedAt:1000,holderEvidence:{status:'ok',observedAt:1000,rows:100,coverageRate:.9,unobservedRate:.1,custodyRate:.4,taggedRiskRate:0,taggedRiskUpperRate:.1,largestWalletRate:.04,top10WalletRate:.4,largestSharedFunderRate:0}};
