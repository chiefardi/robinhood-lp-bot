...
function fixture(when){
 ...
 const fetch=async(_url,opts)=>{if(opts?.method==='POST'){if(when==='build')paused=true;return {ok:true,json:async()=>({code:0,data:{data:'0xabc',routerAddress:ROUTER,transactionValue:when==='simulation'?'10':'0',amountIn:'10',amountOut:'10'}})}}return{ok:true,json:async()=>({code:0,data:{routeSummary:{amountOut:'10'},routerAddress:ROUTER}})}};
